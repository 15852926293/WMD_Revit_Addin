...
{
    public class QuickGridDimensionCmd
    {
        ExternalCommandData commandData = null;
        UIDocument uiDoc = null;
        Document doc = null;
        Application app = null;
        public string gridDimensionName = "";

        public QuickGridDimensionCmd(ExternalCommandData commandData)
        {
        ...
        public void QuickGridDimension()
        {
